...
public class SecurityService extends WebMvcConfigurerAdapter {
    ...
    protected static class LoginConfig extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(AuthenticationManagerBuilder auth) throws Exception {
            ...
            .and().withUser("user1").password("password1").authorities("USER", "MANAGER", "LIST_PRODUCT")
            .and().withUser("user2").password("password2").authorities("USER", "MANAGER", "FIND_PRODUCT");
        }
    }
